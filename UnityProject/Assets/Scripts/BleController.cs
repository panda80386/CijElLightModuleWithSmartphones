...
namespace Panda.BLELibrary
{

    public class BleController : MonoBehaviour
    {
        const string DeviceName = "CijElLightModule2";
        const string ServiceUUID = "164aedcc-bb49-11ed-afa1-0242ac120002";
        const string CharacteristicUuidRx = "164af06a-bb49-11ed-afa1-0242ac120002"; // Rxって書いてるけど、ここでは送信用。Unity -> Esp32
        ...
        private Subject<string> _statusText = new Subject<string>();

        public IObservable<object> OnInitialized => _onInitialized;
        private Subject<object> _onInitialized = new Subject<object>();
                        ...
                        case States.Connect:
                            ...
                            BluetoothLEHardwareInterface.ConnectToPeripheral(_deviceAddress, null, null, (address, serviceUUID, characteristicUUID) =>
                            {
                                ...
                                if (IsEqual(serviceUUID, ServiceUUID))
                                {
                                    ...
                                    _foundLedUUID = _foundLedUUID || IsEqual(characteristicUUID, CharacteristicUuidRx);
        ...
        public void SendByte(byte value) => SendBytes(new[] { value });

        public void SendBytes(byte[] values)
        {
            BluetoothLEHardwareInterface.WriteCharacteristic(_deviceAddress, ServiceUUID, CharacteristicUuidRx, values, values.Length, false, (characteristicUUID) =>
            {
